...
recognizer.py is a wrapper for pocketsphinx.
  parameters:
    ~fsg - filename of language model
...
class recognizer(object):
    ...
    def __init__(self):
        ...
        if rospy.has_param(self._fsg_param) and rospy.has_param(self._dic_param):
            self.start_recognizer()
        else:
            rospy.logwarn("fsg and dic parameters need to be set to start recognizer.")
    ...
    def shutdown(self):
        ...
        for param in [self._device_name_param, self._fsg_param, self._dic_param]:
